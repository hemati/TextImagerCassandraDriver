...
public class WikiDragonCassandraCollectionReader extends CasCollectionReader_ImplBase {
	...
	private void init() throws CollectionException, IOException{
		...
		System.out.println("total documents" +pooledDocumentsRelevant);
	}
	...
	public void getNext(CAS cas) throws IOException, CollectionException {
		if (next != null) {
			System.out.println("neeeeext" + next[1]);
			...
			if (cas != null) {
				try {
					System.out.println(new String(lBytes));
	...
	public Progress[] getProgress() {
		return new Progress[]{new ProgressImpl(pooledDocumentsRead, pooledDocumentsRelevant, Progress.ENTITIES)};
	}
